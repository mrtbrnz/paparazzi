...
#ifndef SDP3X_AS_EXTERNAL_SENSOR
#define SDP3X_AS_EXTERNAL_SENSOR TRUE
#endif
...
static void sdp3x_downlink(struct transport_tx *trans, struct link_device *dev)
{
  ...
  pprz_msg_send_AIRSPEED_SDP3X(trans,dev,AC_ID,
                                &sdp3x.pressure,
                                &temp,
                                &sdp3x.airspeed);
}
...
#if PERIODIC_TELEMETRY
  register_periodic_telemetry(DefaultPeriodic, PPRZ_MSG_ID_AIRSPEED_SDP3X, sdp3x_downlink); // FIXME
#endif
}
