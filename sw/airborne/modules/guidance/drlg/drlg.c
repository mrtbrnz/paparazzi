...
/** @file .c
 *  Deep RL Guidance, acceleration setpoint sender for full_INDI guidance.
 *
 */
...
#include "autopilot.h"
#include "modules/guidance/drlg/drlg.h"
...
void drlg_read_msg(void)
{
  ...
  if (ac_id == AC_ID) {
    ...
    AbiSendMsgACCEL_SP(ACCEL_SP_DRLG_ID, flag, &u);
